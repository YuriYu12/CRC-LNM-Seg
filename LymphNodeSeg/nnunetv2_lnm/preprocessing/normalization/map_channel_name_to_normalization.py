...
from nnunetv2_lnm.preprocessing.normalization.default_normalization_schemes import CTNormalization, NoNormalization, \
    ZScoreNormalization, RescaleTo01Normalization, RGBTo01Normalization, ImageNormalization, ClipRescaleTo01Normalization, \
    AbdomenWindowCTNormalization
...
channel_name_to_normalization_mapping = {
    ...
    'abdCT': AbdomenWindowCTNormalization,
    'vessel': NoNormalization,
    'distance': ClipRescaleTo01Normalization,
}
