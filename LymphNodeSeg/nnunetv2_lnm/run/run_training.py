...
from nnunetv2_lnm.run.load_pretrained_weights import load_pretrained_weights
...
def get_trainer_from_args(dataset_name_or_id: Union[int, str],
    ...
    nnunet_trainer = recursive_find_python_class(join(nnunetv2_lnm.__path__[0], "training", "nnUNetTrainer"),
    ...
    if nnunet_trainer is None:
        raise RuntimeError(f'Could not find requested nnunet trainer {trainer_name} in '
                           f'nnunetv2_lnm.training.nnUNetTrainer ('
                           f'{join(nnunetv2_lnm.__path__[0], "training", "nnUNetTrainer")}). If it is located somewhere '
...
def run_training(dataset_name_or_id: Union[str, int],
    ...
    if num_gpus > 1:
        ...
        nnunet_trainer.perform_actual_validation(export_validation_probabilities, use_checkpoint='best')
